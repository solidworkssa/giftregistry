# 17-giftregistry - Base Native Architecture
...
On-chain gift and wish list manager

## Overview

Giftregistry provides a decentralized solution for wish list creation and gift claiming on both Base (EVM) and Stacks blockchains.
